...
After installing/configuring `pacman` with devkitPro's repositories, you can get everything you need with `pacman -S git make cmake libfat-ogc python python-cairosvg wii-cmake wii-dev wii-sdl2 wii-sdl2_image wii-sdl2_mixer wii-sdl2_ttf`.
